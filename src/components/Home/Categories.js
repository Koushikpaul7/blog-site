        ...
        <div className='container-fluid'>
            ...
            <div className='container'>
                <div className='row  gap-md-0'>
                    ...
                    <div className='col-12  col-md-3 mb-2 '>
                        <div class="card point card-border " >
                            <img src="https://www.aha.org/sites/default/files/styles/900x400/public/2020-10/aonl-cta-news-covid19-update.png?itok=x-AyXMOG" class="card-img-fluid" style={{height:"150px"}} alt="..." />
                            <div class="card-body">
                    ...
                    <div className='col-12  col-md-3 mb-2'>
                        <div class="card point card-border rounded-4 ">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Law News</h5>
