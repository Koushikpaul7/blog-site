            ...
            <div className='row '>
                <div className='col-12 col-md-6  border-end'>
                    ...
                    <div
                        ...
                        <h3 className='pb-5 border-bottom'>A general meeting was placed at uttara for the development</h3>
                    </div>
                    <div className='row g-5 mt-3'>
                        <div
                            ...
                            <h5 className='border-bottom pb-3'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </h5>
                        </div>
                        <div
                            data-aos="zoom-in"
                            data-aos-duration='1000'
                ...
                <div className='col-12 col-md-6 '>
                    ...
                    <div
                        ...
                        <h3 className='pb-5 border-bottom'>With the formula of Pallibandhu vote occasion can be done more effectively</h3>
                    </div>
                    <div className='row g-5 mt-3'>
                        <div
                            data-aos="zoom-in"
