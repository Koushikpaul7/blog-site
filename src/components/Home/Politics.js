            ...
            <div className='row '>
                <div className='col-12 col-md-6 px-5 border-end'>
                    ...
                    <div className='row g-5 mt-3'>
                        <div className='col-6 col-md-6 border-bottom'>
                ...
                <div className='col-12 col-md-6 px-5'>
                    ...
                    <img src="https://cdn.jagonews24.com/media/imgAllNew/BG/2019November/cc-20230101195129.jpg" className='img-fluid zoom' alt="" />
